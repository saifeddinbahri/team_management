...
import { REGISTER_MUTATION } from "@/schema/mutations";
    ...
    const handleSignUp = async () => {
      ...
      if (gqlAPI) {
        ...
        if (Reflect.has(resBody, 'errors')) {
          ...
          await authenticateAction(resBody.data.register)
        }
      }
    }
    return (
  <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
    <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="space-y-4">
        ...
        <button onClick={handleSignUp} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2.5 rounded-lg transition-colors">
            SignUp
        </button>
      </div>
